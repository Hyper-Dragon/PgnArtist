...
[TestClass()]
public class ShadowBoardRendererTests
{
    private static IServiceProvider? provider = null;


    [ClassInitialize]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0060:Remove unused parameter", Justification = "Called by framework")]
    public static void TestFixtureSetup(TestContext context)
    {
        ...
        services.AddLogging(logging => logging.AddConsole())
                .AddHttpClient()
                .AddSingleton(typeof(IBoardRenderer), typeof(ShadowBoardRenderer));
